	...
	<table cellspacing="0" class="table table-bordered">
      <thead>
      	<tr>
      		<th colspan="4">
		        <ul class="toolbar">
		          <li><a href="back/inscribes_input" class="button button-success">添加</a></li>
		        </ul>
	    	</th>
	    </tr>
        <tr>
      ...
      <s:iterator value="pageModel.objects">
        <tr>
          ...
          <td><img style="width:100px;" src="upload/inscribes/<s:property value="logo"/>"></td>
          <td><a href="back/inscribes_input?id=<s:property value="id"/>" class="button button-primary">编辑</a>
          		<a href="back/inscribes_delete?id=<s:property value="id"/>" class="button button-danger">删除</a>
          </td>
        </tr>
      </s:iterator>
      </tbody>
