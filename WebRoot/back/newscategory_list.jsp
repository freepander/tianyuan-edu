	...
	<table cellspacing="0" class="table table-bordered">
      ...
      <s:iterator value="list">
        <tr>
          ...
          <td>
          	<a href="back/newscategory_input?id=<s:property value="id"/>" class="button button-primary">编辑</a>
          	<a href="back/newscategory_delete?id=<s:property value="id"/>" class="button button-danger">删除</a></td>
        </tr>
      </s:iterator>
      </tbody>
    </table>
    <form action="back/newscategory_add" method="post">
